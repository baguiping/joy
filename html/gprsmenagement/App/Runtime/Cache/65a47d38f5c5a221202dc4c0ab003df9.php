...
<form onSubmit="return checkValue();" method="post" name ="addform" action="<?php echo U('Device/editsave','id='.$groupinfo['groupid']);?>}">
	<div class="item">
     <span class="title"><span style="color:red;">* </span>组名称:</span>
     <input type="text"  class="text_2" value="<?php echo ($groupinfo["groupname"]); ?>" maxlength="20" name="groupname" id="groupname"><span class="lr" id="groupnameErr"></span>	
   </div>
 	 <div class="item">
     <span class="title">描述:</span>
     <input type="text"  class="text_2" value="<?php echo ($groupinfo["remark"]); ?>" maxlength="20" name="remark" id="remark">
   </div>
