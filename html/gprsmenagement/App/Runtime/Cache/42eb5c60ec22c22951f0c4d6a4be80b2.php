...
{   
  ...
  $em.eq(6).addClass("main_menu_act");
  $em.eq(6).children(0).removeClass().addClass("i-hd6_act");
});
</script>
</head>
<body>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/login.png"></i><span>登陆日志</span></h4>
        <div class="LtMenu">
        	<ul>	
                <li onclick="navigation(this)"  class="battery_1"><a href="<?php echo U('Log/loginfo');?>" title="日志信息" target='mainFrame' class="act">日志信息</a></li>
			</ul>
        </div>

	</div>
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('Log/loginfo');?>" name="mainFrame"
