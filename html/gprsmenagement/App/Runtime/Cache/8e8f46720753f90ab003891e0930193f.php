...
<body>
	<form onSubmit="1" method="post" action="<?php echo U('Device/export');?>">
		...
		<div style="margin-top:10px; text-align:center">
			<input class="submit_1" type="submit" value="确定"  onClick="javascript:parent.closeDialog();" style="margin-top:10px;">
