...
<form onSubmit="" method="post" name ="addform" action="">
   ...
   <div class="item">
     ...
     <input type="text"  class="text_2" value="13333333333" maxlength="20" name="phone" id="phone">
   </div>
   <div class="item">
     <span class="title">IC卡编号:</span>
     <input type="text"  class="text_2" value="123456" maxlength="20" name="ICNO" id="ICNO">
   </div>
   <div class="item">
		<span class="title">权限等级:</span>
		<select name="lease" id="lease" disabled="true">
