...
{   
  ...
  $em.eq(3).addClass("main_menu_act");
  $em.eq(3).children(0).removeClass().addClass("i-hd4_act");
});
</script>
</head>
<body>
...
<div class="wapper">  
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/battery.png"></i><span>电池管理</span></h4>
        <div class="LtMenu">
        	<ul>	
                <li onclick="navigation(this)"  class="battery_1"><a href="<?php echo U('Battery/batteryinfo');?>" title="电池组信息" target='mainFrame' class="act">电池组信息</a></li>
    ...
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('Battery/batteryinfo');?>" name="mainFrame"
