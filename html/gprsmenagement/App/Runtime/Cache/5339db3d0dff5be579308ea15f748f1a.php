...
{   
  ...
  $em.eq(2).addClass("main_menu_act");
  $em.eq(2).children(0).removeClass().addClass("i-hd2_act");
});
</script>
<body>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/monitor.png"></i><span>设备管理</span></h4>
        <div class="LtMenu">
        	<ul>	
                <li onclick="navigation(this)" class="monitor_1"><a href="<?php echo U('Device/deviceinfo');?>" title="设备管理" target='mainFrame' class="act">设备管理</a></li>
				</ul>
        </div>

	</div>
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('Device/deviceinfo');?>" name="mainFrame"
