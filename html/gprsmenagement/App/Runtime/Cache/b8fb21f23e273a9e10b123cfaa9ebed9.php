...
<body>
<div>
<div style="height:630px;overflow-y:auto;" id="kk">
<form onSubmit="return checkValue();" method="post" name ="addform" action="">
    <div class="item">
     <span class="title"><span style="color:red;">* </span>姓名:</span>				
		 <input class="text_2" name="account" type="text" id="account" style="width:180px"><span class="lr" id="accountErr"></span>	 
   </div>
 	 <div class="item">
     <span class="title"><span style="color:red;">* </span>出生年月:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="brithyday" id="brithyday"><span class="lr" id="brithydayErr"></span>	 
   </div>
   <div class="item">
	...
	<div class="item">
     ...
     <input type="text"  class="text_2" value="" maxlength="20" name="jiashizheng" id="jiashizheng">
   </div>
   <div class="item">
     <span class="title"><span style="color:red;">* </span>联系电话:</span>
     <input type="text"  class="text_2" value="" maxlength="11" name="phoneno" id="phoneno" onKeyUp="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"><span class="lr" id="phonenoErr"></span>	 
   </div>
   <div class="item">
     <span class="title"><span style="color:red;">* </span>IC卡编号:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="icno" id="icno" onKeyUp="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)"><span class="lr" id="icnoErr"></span>
   </div>
   <div class="item">
	...
	<div class="item">
     ...
     <input type="text"  class="text_2" value="" maxlength="20" name="accountname" id="accountname">
   </div>
   <div class="item">
     <span class="title">账户密码:</span>
     <input type="password"  class="text_2" value="" maxlength="20" name="password" id="password">
   </div>
  
   <div class="item">
     <span class="title">EMAIL:</span>
     <input type="text"  class="text_2" value="" name="email" id="email">
   </div> 
    <div class="item">
