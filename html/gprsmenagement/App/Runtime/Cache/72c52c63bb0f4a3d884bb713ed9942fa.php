...
<form onSubmit="" method="post" name ="addform" action="">
    <div class="item">
     ...
     <pre class="prettyprint" id="start" style="display:none">$.calendar({ format:'yyyy-MM-dd HH:mm:ss', real:'#start1' });</pre>					
		 <input class="runcode" name="start" type="text" id="start1" style="width:180px">
		 
   </div>
    <div class="item">
     <span class="title">结束时间:</span>
     <pre class="prettyprint" id="end" style="display:none">$.calendar({ format:'yyyy-MM-dd HH:mm:ss' , real:'#end1' });</pre>					
		 <input class="runcode" name="end" type="text" id="end1" style="width:180px">
		 
   </div>
   <div class="item">
     <span class="title">租赁车辆选择:</span>
	 <div style="margin-left:120px;margin-top:-25px;">
	 <input type="text"  class="text_2" value="" maxlength="20" name="selvehicel" id="selvehicel">
	 </div>
	</div>
   <div class="item">
   ...
   <div class="item">
     ...
     <input type="text"  class="text_2" value="" maxlength="20" name="brithday" id="brithday">
   </div>
   <div class="item">
   ...
   <div class="item">
	...
	<div class="item">
     ...
     <input type="text"  class="text_2" value="" maxlength="20" name="registertime" id="registertime">
   </div>
   <div class="item">
     <span class="title">账户名称:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="account" id="account">
   </div>
   <div class="item">
     <span class="title">账户密码:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="password" id="password">
   </div>
   <div class="item">
