...
var manager = null;	
     $(function ()
        { 
		 var dataGrid = [
			 <?php
 echo "{id:1, name:'司机1', mac:'123' },"; echo "{id:2, name:'司机2', mac:'234' },"; echo "{id:3, name:'司机3', mac:'345' }"; ?>
           
                ];
            var dataGridColumns = [
                { header: 'IC卡编号', name: 'id', width: 50 },
...
<div  position="mainright" style="margin-top:10px;width:450px;height:480px;float:right;">
	...
	<div style="width:300px; height:480px; margin-right:10px;float:right; border:1px solid #ccc; overflow:auto;  ">
    	<ul id="tree1">
	 <?php
 echo "<li id=1>"; echo "<span>管理员1</span><ul>"; echo "<li id=5,134><span>黄先生</span></li>"; echo "<li id=6,166><span>王先生</span></li>"; echo "</ul></li>"; echo "<li id=2>"; echo "<span>管理员2</span><ul>"; echo "<li id=7,157><span>王女士</span></li>"; echo "<li id=8,158><span>陈先生</span></li>"; echo "</ul></li>"; ?>
    	</ul>
    </div> 
	</div>	
</div>
