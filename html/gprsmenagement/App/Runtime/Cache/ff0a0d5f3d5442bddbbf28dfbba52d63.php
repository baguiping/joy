...
<div class="center">
  	    <div class="handList">
        	<ul>
                ...
                <li><a href="<?php echo U('Vehiclemaintenance/index');?>" target="_blank" title="车辆保养与维护"><em class="main_menu_act"><i class="i-hd3_act"></i></em><span>车辆保养与维护</span></a></li>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/maintenance.png"></i></i><span>车辆保养与维护</span></h4>
        <div class="LtMenu">
        	<ul>	
                <li onclick="navigation(this)" class="maintenance_1"><a href="<?php echo U('Vehiclemaintenance/statealarm');?>" title="状态报警" target='mainFrame' class="act">状态报警</a></li>
				
                <li onclick="navigation(this)" class="maintenance_2"><a href="<?php echo U('Vehiclemaintenance/maintenance');?>" title="保养与维护" target='mainFrame'>保养与维护</a></li>
            </ul>
        </div>

	</div>
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('Vehiclemaintenance/statealarm');?>" name="mainFrame"
