...
<div  position="mainright" style="margin-top:10px;width:450px;height:480px;float:right;">
	...
	<div style="width:300px; height:480px; margin-right:10px;float:right; border:1px solid #ccc; overflow:auto;  ">
    	<ul id="tree1">
	 <?php
 echo "<li id=1>"; echo "<span>司机1</span><ul>"; echo "<li id=5,134><span>车辆3</span></li>"; echo "<li id=6,166><span>车辆4</span></li>"; echo "</ul></li>"; echo "<li id=2>"; echo "<span>司机2</span><ul>"; echo "<li id=7,157><span>车辆4</span></li>"; echo "<li id=8,158><span>车辆5</span></li>"; echo "</ul></li>"; ?>
    	</ul>
    </div> 
	</div>	
</div>
