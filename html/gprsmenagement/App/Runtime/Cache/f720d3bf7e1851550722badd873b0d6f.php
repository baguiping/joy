...
{   
  ...
  $em.eq(5).addClass("main_menu_act");
  $em.eq(5).children(0).removeClass().addClass("i-hd5_act");
});
</script>
</head>
<body>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/report.png"></i><span>报表</span></h4>
        <div class="LtMenu">
        	<ul>	
              <li onclick="navigation(this)" class="report_2"><a href="<?php echo U('Report/baobiaofenxi');?>" title="报表分析" target='mainFrame' class="act">报表分析</a></li>
            </ul>
        </div>

	</div>
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('Report/baobiaofenxi');?>" name="mainFrame"
