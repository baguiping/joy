...
<form onSubmit="" method="post" name ="addform" action="">
     ...
     <input type="text"  class="text_2" value="" maxlength="20" name="batteryfactory" id="batteryfactory">
   </div>
 	 <div class="item">
     <span class="title">电池型号:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="batteryno" id="batteryno">
   </div>
   <div class="item">
     <span class="title">电池标称电压:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="batteryV" id="batteryV">
   </div>
   <div class="item">
     <span class="title">电池容量:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="batterycapacty" id="batterycapacty">
   </div>
	<div class="item">
     <span class="title">电池形状:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="batteryshape" id="batteryshape">
   </div>
   <div class="item">
     <span class="title">维护人员:</span>
     <input type="text"  class="text_2" value="" maxlength="20" name="matenman" id="matenman">
   </div>
   <div class="item">
