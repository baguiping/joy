	...
	$(function() {  
        $("#button").click(function() { 	
			...
			for($i=1;$i<5;$i++)
		    {
				...
				cfgjson[$("#cfg"+$i).attr("name")] = cfgarray;	
			}
...
<form id="form1" method="post" action="<?php echo U('Config/paramcfgsend');?>" name="form1">
	<div id="seltree" position="left" style="float:left;width:24%;margin-top:-5px;">
	</div>
	<div  id="cfgpage" style="float:right;width:75%;margin-top:8px;">
	</div>	
