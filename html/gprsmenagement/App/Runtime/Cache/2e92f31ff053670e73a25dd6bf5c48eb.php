...
function gotomap() 
{
	window.location.href="http://119.28.12.135:8088/goto.aspx?user=system&psw=GPS2016"; 
	//http://119.28.12.135:8088/navigation/MyMap/MyMap.aspx?user=system&psw=GPS2016
}
</script>
...
<div class="center">
  	    <div class="handList">
        	<ul>
                ...
                <li><a href="<?php echo U('Monitor/index');?>" target="_blank" title="监控系统"><em class="main_menu_act"><i class="i-hd2_act"></i></em><span>监控系统</span></a></li>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/monitor.png"></i><span>监控系统</span></h4>
        <div class="LtMenu">
        	<ul>	
                <li onclick="navigation(this)" class="monitor_1" ><a href="<?php echo U('Monitor/monitor');?>" title="监控中心" target='mainFrame' class="act">监控中心</a></li>
				
                <li onclick="navigation(this)" class="monitor_2"><a href="<?php echo U('Monitor/trackplay');?>" title="轨迹回放" target='mainFrame'>轨迹回放</a></li>
				
				<li onclick="navigation(this)" class="monitor_3"><a href="<?php echo U('Monitor/mymap');?>" title="我的地图" target='mainFrame'>我的地图</a></li>
            </ul>
        </div>

	</div>
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('Monitor/monitor');?>" name="mainFrame"
