...
function about() 
{
	 var editUrl = "<?php echo U('System/about');?>";
	 parent.openDialog("系统软件版本",450,300,editUrl,refreshPage,"");
}
$(document).ready(	function()
{   
  var $em = $( ".handList" ).find("em");
  $em.eq(8).addClass("main_menu_act");
  $em.eq(8).children(0).removeClass().addClass("i-hd8_act");
});
</script>
</head>
<body>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/system.png"></i><span>系统信息</span></h4>
        <div class="LtMenu">
        	<ul>	   
             <li onclick="navigation(this)" class="config_2"><a title="版本信息"  onclick="about()" class="act">版本信息</a></li>	
            </ul>
        </div>

	</div>
    <div class="inRight">
		<iframe id="mainFrame" src="" name="mainFrame"
