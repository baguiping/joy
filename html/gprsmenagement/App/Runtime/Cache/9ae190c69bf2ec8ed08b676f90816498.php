...
{   
  ...
  $em.eq(7).addClass("main_menu_act");
  $em.eq(7).children(0).removeClass().addClass("i-hd7_act");
});
</script>
</head>
<body>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/config.png"></i><span>设置</span></h4>
        <div class="LtMenu">
        	<ul>	
                <li onclick="navigation(this)" class="config_1"><a href="<?php echo U('Config/paramcfg');?>" title="BMS参数设置" target='mainFrame' class="act">BMS参数设置</a></li>	
				<li onclick="navigation(this)" class="config_1"><a href="<?php echo U('Config/devcfg');?>" title="设备参数设置" target='mainFrame'>设备参数设置</a></li>	
			</ul>
        </div>

	</div>
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('Config/paramcfg');?>" name="mainFrame"
