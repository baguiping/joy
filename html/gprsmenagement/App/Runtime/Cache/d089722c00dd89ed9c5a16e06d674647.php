...
{   
  ...
  $em.eq(1).addClass("main_menu_act");
  $em.eq(1).children(0).removeClass().addClass("i-hd1_act");
});
</script>
</head>
<body>
...
<div class="wapper">
	...
	<div class="inLeft">
    	<h4><i class="i-LtIco1"><img src="__ROOT__/Public/Images/submenu/usermenage.png"></i><span>帐号管理</span></h4>
        <div class="LtMenu">
        	<ul>	
                <li onclick="navigation(this)"  class="battery_1"><a href="<?php echo U('User/userinfo');?>" title="用户信息" target='mainFrame' class="act">用户信息</a></li>
    ...
    <div class="inRight">
		<iframe id="mainFrame" src="<?php echo U('User/userinfo');?>" name="mainFrame"
