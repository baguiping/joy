...
<body>
	<div style="height:150px;" class="bodyborder">
		<form onSubmit="1" method="post" action="<?php echo U('Device/deldevice');?>">
			<div style="color:#000000;height:40px;text-align:center;border:#999999 1px solid; background:#CCCCCC;margin-top:10px;padding:6px">
				<p>
				<span>你确定要删除吗？</span>
				<input type="hidden"  class="text_2" value="<?php echo ($delid); ?>"  name="indexId" id="indexId">
			</div>
