...
public class CRC16 {  
    ...
    public static int calcCrc16(ByteBuf data)
    {
		ByteBuf cpbuf = data.copy();
		byte[]  srcData = new byte[cpbuf.readableBytes()];
		cpbuf.readBytes(srcData);
		return calcCrc16(srcData, 0, srcData.length);  
    }
